        ...
        <ul class="todo-list" data-widget="todo-list">
           @foreach($appointments as $appointment)
            <li>
                ...
                @endif
                <button type="button" class="btn btn-sm btn-default edit bg-light text-dark" data-id="{{$appointment->id}}"><i class="fa fa-info-circle" aria-hidden="true"></i></button>
            ...
            console.log(appointmentdata[0].name_showlast);
                var tableHtml = `
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" class="form-control form-control-plaintext" readonly value="${appointmentdata[0].utype}" style="border: none; background-color: transparent; box-shadow: none;"></td>
                                <td><input type="text" class="form-control form-control-plaintext" readonly value="${appointmentdata[0].admitteddatetime}" style="border: none; background-color: transparent; box-shadow: none;"></td>
                                <td><input type="text" class="form-control form-control-plaintext" readonly value="${appointmentdata[0].description}" style="border: none; background-color: transparent; box-shadow: none;"></td>
                            </tr>
                        </tbody>
                    </table>
                `;
